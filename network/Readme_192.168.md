# Что вообще делали? (записать на листик рядом, чтобы рассказывать)
1. Зашли в путти
...
Далее можем выполнить 9пункт из заданий про iPerf3
#Сначала скачиваем пакеты:
